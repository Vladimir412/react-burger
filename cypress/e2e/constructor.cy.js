describe("constructor test", () => {
  ...
  it("should click on ingredient and close modal", () => {
    ...
    cy.get("div").as("ingrdient-ditails");//????
    // cy.get("@ingrdient-ditails").get("img").should('have.value', "@price");
    cy.get("@ingrdient-ditails").get("h2").should('have.value', "Картоная булка N-200i");
