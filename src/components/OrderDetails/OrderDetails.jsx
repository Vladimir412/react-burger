...
const OrderDetails = (props) => {
    ...
    return (
        <div className={orderDetailsStyles.container}>
            <p className='text text_type_digits-large'>{props.dataOrderModal.order.number}</p>
            <p className={`${orderDetailsStyles.identity} text text_type_main-medium`}>идентификатор заказа</p>
            <button className={orderDetailsStyles.buttonImage} onClick={props.closeModal}></button>
