...
export const getIngredientsItemRequest = createAction('GET_INGREDIENTS_ITEM_REQUEST');
export const getIngredientsItemSuccess = createAction('GET_INGREDIENTS_ITEM_SUCCESS');
export const getIngredientsItemError = createAction('GET_INGREDIENTS_ITEM_ERROR')

export const getAndUpdateNumberOrderItemRequest = createAction('GET_AND_UPDATE_NUMBER_ORDER_REQUEST')
export const getAndUpdateNumberOrderItemSuccess = createAction('GET_AND_UPDATE_NUMBER_ORDER_SUCCESS')
export const getAndUpdateNumberOrderItemError = createAction('GET_AND_UPDATE_NUMBER_ORDER_ERROR')
...
export const modalIngredientItemOpen = createAction('MODAL_INGREDIENT_ITEM_OPEN')
export const modalIngredientItemClosed = createAction('MODAL_INGREDIENT_ITEM_CLOSED')
